...
# Tbv Ubuntu
curl -u 'cx1964@gmail.com' https://api.github.com/user/repos -d '{"name":"cx1964BladMuziek"}'

# tbv mingw64 onder windows
# letop vul voor <PASSWORD> een password waarde in
#curl -d '{"name":"cx1964BladMuziek"}' -u cx1964@gmail.com:<PASSWORD> https://api.github.com/user/repos
...
git remote add origin https://github.com/cx1964/cx1964BladMuziek.git
