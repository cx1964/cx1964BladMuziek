\version "2.22.2"
% file: werkend_voorbeeld_lilypond_piano_grandstaf_v000.ly
...
\book {
  \header {
    ...
    tagline = "werkend_voorbeeld_lilypond_piano_grandstaf_v000c.ly  nog pagina nummer" % dit onderdrukt de default footer
  }
